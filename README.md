...
2. Go to **GitHub** in your Zenodo account settings, find this repository
   in the list, and flip the toggle to **On**.
3. Create a **Release** on GitHub (not just a commit/tag push) — e.g.
   `v1.0.0`, "Submission version". Zenodo automatically archives it and
   mints a DOI within a few minutes.
4. Copy the DOI badge Zenodo gives you into the top of this README,
   replacing the placeholder badge above.
5. Use that DOI in your manuscript's Data Availability statement.
